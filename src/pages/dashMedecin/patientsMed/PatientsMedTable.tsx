...
const PatientsMedTable = ({
  ...
  const handleShowInfo = () => navigate('/verticalMed/patientMed-profile');
  ...
  const columns: ColumnProps<IPatient>[] = [
    ...
    },
    {
      ...
      title: 'Numéro',
      render: (phone) => (
        <span className='d-flex align-baseline nowrap' style={{ color: '#0B8FAC' }}>
...
export default PatientsMedTable;
