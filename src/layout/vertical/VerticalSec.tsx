...
const VerticalSecLayout = ({ children }: Props) => {
  ...
  const sideNav = (
    ...
    >
      ...
      <div className='assistant-menu' color='blue'><h4 >Secrétaire</h4></div>
...
<br></br>
    <Menu className='assistant-menu' orientation='vertical'>
        <NavLink
          to='/verticalSec/secretaire-dashboard'
    ...
    <Menu className='assistant-menu' orientation='vertical'>
        <NavLink
          to='/verticalSec/appointmentsSec'
          className={`link ${({ isActive }) => (isActive ? 'active' : 'inactive')}`}
          replace
        >
    ...
    <Menu className='assistant-menu' orientation='vertical'>
        <NavLink
          to='/verticalSec/doctors'
          className={`link ${({ isActive }) => (isActive ? 'active' : 'inactive')}`}
          replace
        >
          <span className='link-icon icofont-doctor' />
          <span className='link-text'>Gérer les médecins</span>
        </NavLink>
    </Menu> 
    ...
    <Menu className='assistant-menu' orientation='vertical'>
        <NavLink
          to='/verticalSec/patients'
          className={`link ${({ isActive }) => (isActive ? 'active' : 'inactive')}`}
          replace
        >
          <span className='link-icon icofont-paralysis-disability' />
          <span className='link-text'>Gérer les patients</span>
        </NavLink>
    </Menu> 
...
export default VerticalSecLayout;
